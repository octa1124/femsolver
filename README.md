...
- Implemented now:
  ...
  - a first linear magnetostatic smoke solve in `motor_solve` that binds real case and manifest semantics, assembles `J` and `B_r` sources, imports the generated tetra mesh when available, and reports magnetic-energy plus flux-density summaries
- Explicitly not implemented yet:
  ...
  - machine-grade field post-processing, torque evaluation, and field export on real machine meshes
